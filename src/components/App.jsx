  ...
  return (
    <div className="App">
      <div className="page__content">
        ...
        <PopupWithForm name='add' title='Новое место' button='Создать' isOpen={isAddPopupOpen} onClose={closeAllPopups}>
        <label className="popup__form-field">
                  <input
                    id="title-input"
                    type="text"
        ...
        <PopupWithForm name='save-avatar' title='Обновить аватар' button='Сохранить' isOpen={isAvatarPopupOpen} onClose={closeAllPopups}>
        <label className="popup__form-field">
                  <input
                    id="avatar-input"
                    type="url"
